...
function App() {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("div", { id: "display" }, display || "0"), /*#__PURE__*/
    React.createElement("div", { id: "first-row" }, /*#__PURE__*/
    React.createElement("div", { className: "button clear", id: "clear", onClick: clear }, "AC"), /*#__PURE__*/
    React.createElement("div", { className: "button equals", id: "equals", onClick: equals }, "=")), /*#__PURE__*/

    React.createElement("div", { id: "second-row" }, /*#__PURE__*/
    React.createElement("div", { className: "button", id: "seven", onClick: () => {updateDisplay("7");} }, "7"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "eight", onClick: () => {updateDisplay("8");} }, "8"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "nine", onClick: () => {updateDisplay("9");} }, "9"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "add", onClick: () => {updateDisplay("+");} }, "+")), /*#__PURE__*/

    React.createElement("div", { id: "third-row" }, /*#__PURE__*/
    React.createElement("div", { className: "button", id: "four", onClick: () => {updateDisplay("4");} }, "4"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "five", onClick: () => {updateDisplay("5");} }, "5"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "six", onClick: () => {updateDisplay("6");} }, "6"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "subtract", onClick: () => {updateDisplay("-");} }, "-")), /*#__PURE__*/

    React.createElement("div", { id: "fourth-row" }, /*#__PURE__*/
    React.createElement("div", { className: "button", id: "one", onClick: () => {updateDisplay("1");} }, "1"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "two", onClick: () => {updateDisplay("2");} }, "2"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "three", onClick: () => {updateDisplay("3");} }, "3"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "multiply", onClick: () => {updateDisplay("*");} }, "*")), /*#__PURE__*/

    React.createElement("div", { id: "fifth-row" }, /*#__PURE__*/
    React.createElement("div", { className: "button", id: "zero", onClick: () => {updateDisplay("0");} }, "0"), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "decimal", onClick: () => {updateDisplay(".");} }, "."), /*#__PURE__*/
    React.createElement("div", { className: "button", id: "divide", onClick: () => {updateDisplay("/");} }, "/"))));
